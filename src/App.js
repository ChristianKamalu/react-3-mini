...
class App extends Component {
  ...
  getVehicles() {
    ...
    axios.get(baseUrl + '/vehicles').then(res => this.setState({ vehiclesToDisplay: res.data })).catch(err => console.error('error:', err))
  }
  ...
  addCar() {
    ...
    // axios (POST)
    // setState with response -> vehiclesToDisplay
    axios.post(baseUrl + '/vehicles', newCar).then(res => this.setState({ vehiclesToDisplay: res.data.vehicles })).catch(err => console.log('error:', err))
  }
